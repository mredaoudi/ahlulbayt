...
func main() {
	timmy := SunTimes(time.Now(), 50.73722, 3.73770)
	prayers := []string{
		"Fajr | " + timmy["nauticalDawn"].Format("15:04"),
		"Dhuhr | " + timmy["solarNoon"].Format("15:04"),
		"Asr | " + timmy["solarNoon"].Add(time.Hour * 2).Format("15:04"),
		"Maghreb | " + timmy["sunset"].Format("15:04"),
		"Isha | " + timmy["night"].Format("15:04"),
	}
	result := columnize.SimpleFormat(prayers)
	fmt.Println(result)
}
// example:
