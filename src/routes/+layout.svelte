...
>
    <div class="bg-muted/40 hidden border-r md:block">
        <div class="flex h-full sticky top-0 max-h-screen flex-col gap-2">
            <div class="flex items-center border-b p-4 lg:px-6">
                <a
                    href="/"
                    class="w-full flex flex-col items-center gap-1 font-semibold justify-center"
                >
                    <span class="reem-kufi text-2xl">أَهْل ٱلْبَيْت</span>
            ...
            <div class="flex-1">
                <nav class="grid items-center px-2 gap-5 font-medium text-lg lg:px-4">
                    ...
                    <a
                        ...
                        class="{path == 'tools'
                            ? 'bg-muted text-primary'
                            : 'text-muted-foreground'} hover:text-primary flex flex-col items-center gap-3 rounded-lg px-3 py-2 transition-all"
                    >
    ...
    <div class="flex flex-col">
        ...
        >
            <Sheet.Root>
                ...
                <Sheet.Content side="left" class="flex flex-col">
                    <nav class="grid gap-2 text-lg font-medium">
                        ...
                        >
                            <span class="sr-only reem-kufi">أَهْل ٱلْبَيْت</span>
                        </a>
                        <a
                            href="/quran"
                            class="{path == 'quran'
            ...
            <div class="w-full flex justify-center reem-kufi">أَهْل ٱلْبَيْت</div>
            <!-- <DropdownMenu.Root>
